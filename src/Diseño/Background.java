...
public class Background extends JComponent {
    ...
    public Background() {
        image = new ImageIcon(getClass().getResource("/recursos/carroFondo.png"));
    }
    ...
    private void createBlurImage(Graphics2D g) {
        ...
        if (width > 0 && height > 0) {
            ...
            g2.dispose();
            g.drawImage(new ShadowRenderer(shadow, 0.5f, new Color(0, 0, 0)).createShadow(img), (int) (x - shadow * 0.8f), (int) (y - shadow * 0.8f), null);
